...
grid on
leg=legend('Normalized $z$','Normalized $\Delta v_{13}$','Location','southeast');
...
if (save_fig)
%     exportgraphics(fig_psd,'psd13.png','Resolution',600)
    exportgraphics(fig_delay,'delay13.png','Resolution',600)    
end