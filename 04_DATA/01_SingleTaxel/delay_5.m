...
grid on
leg=legend('Normalized $z$','Normalized $\Delta v_{5}$','Location','southeast');
...
if (save_fig)
%     exportgraphics(fig_psd,'psd5.png','Resolution',600)
    exportgraphics(fig_delay,'delay5.png','Resolution',600)
    close all
end