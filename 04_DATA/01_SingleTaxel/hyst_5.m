...
ylabel('$\Delta v_{5}\,$[V]', 'Interpreter', 'latex')  
...
grid on
x = 0.994038072856145;
y_1 = 0.150461933746806;
y_2 = 0.167376618470238;
...
if (save_fig)
    exportgraphics(fig_fv,'hyst_f_vs_v5.png','Resolution',600)     
    close all
end