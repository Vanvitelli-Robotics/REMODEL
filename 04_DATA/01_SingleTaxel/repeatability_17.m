...
tx = text(x+x*0.07,y,['$e_{repeat} = ' num2str(round(err,2)) '\%$'],'Color','r');
...
ylabel('$\Delta v_{17}\,$[V]', 'Interpreter', 'latex')
xlabel('$f_z\,$[N]', 'Interpreter', 'latex')
set(ax,'TickLabelInterpreter','latex')
grid on

if (save_fig)
    exportgraphics(fig_repeat,'repeat17.png','Resolution',600)
    close all
end